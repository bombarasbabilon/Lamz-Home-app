        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-4 text-base border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none transition-all"
              style={{ maxWidth: '100%', boxSizing: 'border-box' }}
            />
          </div>
        </div>
